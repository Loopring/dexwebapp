...
export const Float24Encoding = {
  numBitsExponent: 5,
  numBitsMantissa: 19,
  exponentBase: 10,
};

export const Float16Encoding = {
  numBitsExponent: 5,
  numBitsMantissa: 11,
  exponentBase: 10,
};
...
export function roundToFloat24(value) {
  return roundToFloatValue(value, Float24Encoding);
}

export function roundToFloat16(value) {
  return roundToFloatValue(value, Float16Encoding);
}
