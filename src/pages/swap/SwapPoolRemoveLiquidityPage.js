...
import SwapPoolRemoveForm from 'pages/swap/components/forms/SwapPoolRemoveForm';

const { Content } = Layout;

const SwapPoolRemoveLiquidityPage = () => {
...
export default SwapPoolRemoveLiquidityPage;
